  ...
  join (data) {
    return new Promise((resolve, reject) => {    
      ...
      **/
      ...
      // init client
      this._client.init('Your Agora APPID', () => {
        ...
        **/
        this._client.join(null, 'agora.pi.rtc2', null, (uid) => {
          this._params.uid = uid;
          Toast.notice("join channel: " + 'agora.pi.rtc' + " success, uid: " + uid);
          console.log("join channel: " + 'agora.pi.rtc' + " success, uid: " + uid);
          this._joined = true;
          ...
          // if (data.cameraResolution && data.cameraResolution != 'default') {
            ...
            this._localStream.setVideoProfile('480p');
          // }
